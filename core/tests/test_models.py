...
class ModelTests(TestCase):
    ...
    def test_ingredient_str(self):
        """Test the ingrednient string representation"""
    ...
    def test_recipe_str(self):
        """Test the recipe striong representation"""
    ...
    def test_recipe_file_name_uuid(self, mock_uuid):
        """Test that image is save in correct loc"""
        uuid = 'test-uuid'
