...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@london.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        """test that pass more than 5"""
        payload = {'email': 'test@london.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@london.com', password='testpass')
    ...
    def test_create_token_missing_field(self):
        """Test that email and pass is required"""
